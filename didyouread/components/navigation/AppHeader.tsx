      ...
      <header className="sticky top-0 z-40 border-b border-[#d9e4d6] bg-[#fffef9]/95 backdrop-blur">
        <div className="mx-auto grid min-h-16 max-w-[1500px] grid-cols-[auto_1fr_auto] items-center gap-2 px-3 sm:gap-4 sm:px-6">
          <div className="flex min-w-0 items-center gap-2 sm:gap-4">
            ...
            <Link
              href="/"
              className="flex min-w-0 items-center gap-2 font-semibold text-[#173c28] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#327a4a]"
            >
              <span className="hidden size-8 shrink-0 place-items-center rounded-full bg-[#2f7449] text-white sm:grid">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            <button
              type="button"
              onClick={openUpload}
              className="inline-flex h-10 items-center justify-center gap-2 rounded-md bg-[#225f3b] px-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#184b2d] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#225f3b] sm:px-4"
            >
